...
import { TypeChainContract, promisify, ITxParams, IPayableTxParams, DeferredTransactionWrapper, DeferredEventWrapper } from '${context.relativeRuntimePath}'
...
export class ${typeName} extends TypeChainContract {
    ...
    ${input.constants
      ...
      ${input.constantFunctions
        ...
        return `public ${event.name}Event(eventFilter: ${filterableEventParams}): DeferredEventWrapper<${eventParams}, ${filterableEventParams}> {
                return new DeferredEventWrapper<${eventParams}, ${filterableEventParams}>(this, '${event.name}', eventFilter);
              }`;
    })
        .join(";\n")}
  }`;
